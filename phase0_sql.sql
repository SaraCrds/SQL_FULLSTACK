...
SELECT t1.nom, t1.salaire, tsup.nom AS 'nom_sup', tsup.salaire AS 'salaire_sup' FROM employe as tsup LEFT JOIN employe AS t1 ON t1.nosup = tsup.noemp WHERE t1.salaire > tsup.salaire;
